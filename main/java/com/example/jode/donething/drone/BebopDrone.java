package com.example.jode.donething.drone;
...
/*
    This class is not an Activity, and as such does not have an onCreate method. It acts in the
    background. It has no xml UI and is not in the manifest. It essentially is the engine running
    under BebopActivity's hood.
 */
public class BebopDrone {
    ...
    /**
     * getService method added to retrieve the service information used by the drone object in
     * order to clone drone object
     * @return Drone object's service information. Hopefully this works.
     */
    public ARDiscoveryDeviceService getService(){ return mDeviceService; }
    ...
    /**
     * Set the vertical ascent/descent speed of the drone
